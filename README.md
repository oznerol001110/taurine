...
- 🖱️ Simula piccoli movimenti del mouse per fingere attività
- 🧩 Compatibile con qualsiasi app che rileva inattività
- 🐍 Usa solo Python e `pyautogui` – semplice e cross-versione
- 🖥️ Nessuna finestra fastidiosa, tutto in console
